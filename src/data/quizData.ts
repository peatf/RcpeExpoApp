/**
 * @file quizData.ts
 * @description Quiz questions and structure definitions for the Reality Creation Profile Engine
 * Based on definitions.py from the backend
 */

import { TypologySpectrum, MasterySection } from '../types';

export const TYPOLOGY_SPECTRUMS: TypologySpectrum[] = [
  {
...
export const MASTERY_SECTIONS: MasterySection[] = [
  {
    id: 'core-priorities',
